...
jQuery(document).ready(function ($) {
    $("#spp").mousedown(function (e) {
        if(e.which==3){
        showMessage("秘密通道:<br /><a href=\"https://www.qingwu.shop/user/reg.php\" title=\"分站\">分站</a>    <a href=\"http://www.qingwu.shop/\" title=\"首页\">首页</a>",10000);
}
});
$("#spp").bind("contextmenu", function(e) {
    return false;
});
});
...
jQuery(document).ready(function ($) {
    if (isindex) { //如果是主页
        ...
        if (now > 0 && now <= 6) {
            ...
            showMessage(visitor + ' 欢迎使用沐宸图床，早上好，早起的鸟儿有虫吃噢！早起的虫儿被鸟吃，你是鸟儿还是虫儿？嘻嘻！', 6000);
        } else if (now > 11 && now <= 14) {
            showMessage(visitor + ' 欢迎使用沐宸图床，中午了，吃饭了么？不要饿着了，饿死了谁来挺我呀！', 6000);
        ...
        showMessage('欢迎' + visitor + '来到沐宸云图床《' + title + '》', 6000);
    }
    $(".spp").animate({
        top: $(".spp").offset().top + 300,
...
jQuery(document).ready(function ($) {
    $('h2 a').click(function () {//标题被点击时
        showMessage('正在用吃奶的劲加载《<sppan style="color:#0099cc;">' + $(this).text() + '</sppan>》请稍候');
    });
    $('h2 a').mouseover(function () {
        showMessage('要看看《<sppan style="color:#0099cc;">' + $(this).text() + '</sppan>》这篇文章么？');
    });
    ...
    $('#index-links li a').mouseover(function () {
        showMessage('去 <sppan style="color:#0099cc;">' + $(this).text() + '</sppan> 逛逛');
    });
    $('.comments').mouseover(function () {
        showMessage('<sppan style="color:#0099cc;">' + visitor + '</sppan> 向评论栏出发吧！');
    });
    ...
    $('#tho-shareto sppan a').mouseover(function () {
...
jQuery(document).ready(function ($) {
    $("#spp").mousedown(function (e) {
        _move = true;
        _x = e.pageX - parseInt($("#spp").css("left"));
        _y = e.pageY - parseInt($("#spp").css("top"));
     });
    $(document).mousemove(function (e) {
        if (_move) {
            var x = e.pageX - _x; 
            var y = e.pageY - _y;
            var wx = $(window).width() - $('#spp').width();
            var dy = $(document).height() - $('#spp').height();
